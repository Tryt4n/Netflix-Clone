...
export default function AccountPage() {
  ...
  return (
    <CommonAccountLayout
      pageTitle={`${t("account")} - ${t("settings")}`}
                    ...
                    >
                      ...
                      >
                        ...
                        {!user.defaultKidsProfile && (
                          <li className="account__profile-list-item-wrapper">
                            ...
                            >
                              ...
                              <span className="account__profile-accent-text">{t("transfer")}</span>
                            </a>
                          </li>
                        )}
                        <li className="account__profile-list-item-wrapper">
                        ...
                        <li className="account__profile-list-item-wrapper">
                          ...
                          >
                            <div>
                              <h3 className="account__profile-heading">{t("playbackSettings")}</h3>
                              <em className="account__profile-heading-description account__profile-heading-description--lowercase">
                        ...
                        {!user.defaultKidsProfile && (
                          <li className="account__profile-list-item-wrapper">
                            ...
                            >
                              <div>
                                <h3 className="account__profile-heading">{t("privacyAndData")}</h3>
                              </div>
                              <span className="account__profile-accent-text">{t("change")}</span>
                            </Link>
                          </li>
