...
export default function UserSettingsPage() {
  ...
  const deletingProfileModal = useRef(null);
  ...
  function handleOpenDeletionModal() {
    deletingProfileModal.current.showModal();
    setIsProfileDeleting(true);
  }

  function handleCloseDeletionModal() {
    deletingProfileModal.current.close();
  ...
  return (
    <>
      <main className="user-settings__wrapper open-modal">
        ...
        <dialog
          ...
          ref={deletingProfileModal}
        >
          {isProfileDeleting && <h2 className="user-settings__header">{t("deleteProfile2")}</h2>}
          ...
          <div className="user-settings__modal-text-wrapper">
            <figure>
              <img
                src={currentUser.profileImage}
                alt={`${currentUser.username} ${t("profileAvatar")}`}
                className="user-settings__modal-img"
              />
              <figcaption>{currentUser.username}</figcaption>
            </figure>
            <p>{t("deletionProfileDescription")}</p>
          </div>
          ...
          <div className="user-settings__modal-btn-wrapper">
            <button
              className="user-settings__confirmation-btn user-settings__confirmation-btn--accent"
